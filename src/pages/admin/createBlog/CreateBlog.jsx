    ...
    return (
        <div className='container mx-auto max-w-5xl py-6'>
            <div className="p-5" style={{
                ...
                {/* Editor  */}
                <Editor
                    apiKey='7d9t34n5ifk3184wkw72ac06br8xz3fzqmjotk40s8lb4ybt'
                ...
                <Button className="w-full mt-5" onClick={addPost}
                    style={{
                        background: mode === 'dark' ? 'rgb(226, 232, 240)' : 'hsl(144.82758620689654, 32.58426966292136%, 17.45098039215686%)',
                        color: mode === 'dark' ? 'hsl(173.79310344827587, 32.58426966292136%, 17.45098039215686%)' : 'rgb(226, 232, 240)'
                    }}
                >
                    Send
                </Button>
