...
function BlogInfo() {
  ...
  return (
    <Layout>
      <section style={{borderRadius:'0.5rem', height:'auto', overflow:'hidden',maxWidth: '56rem', marginLeft:'auto', marginRight:'auto', paddingLeft:'1rem', paddingRight:'1rem'}}>
        <div className="lg:py-8" style={{paddingTop:'1rem', paddingBottom:'1rem'}}>
          {loading ?
            <Loader />
            :
            <div >
                {/* Thumbnail  */}
                <img alt="content" style={{borderRadius:'0.5rem', marginBottom:'0.75rem', height:'100%', width:'100%'}}
                  src={getBlogs?.thumbnail}
                />
                {/* title And date  */}
                <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'0.75rem'}}>
                  <h1 style={{ color: mode === 'dark' ? 'white' : 'black', fontSize:'1.25rem', lineHeight:'1.75rem', fontWeight:'600'}}
                ...
                <div
                  style={{borderBottomWidth:'1px', marginBottom:'1.25rem', borderColor:'gray'}}
