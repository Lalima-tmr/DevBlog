  ...
  return (
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-10 mx-auto max-w-7xl" style={{ position: 'relative', width: '100%', height: '90vh', top: '10px' }}>
          {/* Main Content */}
          <div className='card' style={{ position: 'absolute', width: '20rem', height: '20rem', left: '10rem', bottom: '10px', top: '10px' }}>
            {getAllBlog.length > 0
              ? (
                <>
